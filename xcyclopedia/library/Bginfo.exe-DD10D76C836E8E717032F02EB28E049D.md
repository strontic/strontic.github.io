...
*The following table contains possible examples of `Bginfo.exe` being misused. While `Bginfo.exe` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
