---
title: ptSSO.dll | ptSSO
excerpt: What is ptSSO.dll?
---

# ptSSO.dll 

* File Path: `C:\Program Files (x86)\Cisco Systems\Cisco Jabber\MeetingSDK\ptSSO.dll`
* Description: ptSSO
* Comments: WebEx PT Single Sign On Module
...
Type | Hash
-- | --
MD5 | `3823E6951BDE976E5588185BEFC790EA`
SHA1 | `BF391BC9575B3DB972362E5CEAAAE14393534657`
SHA256 | `D1456CF4E3239B48B4781F98C8D39173DD49E6CE80CFF9380A85D5FF2B4EC9B9`
SHA384 | `60F066D989767023A788712A989D844E1F515F03A9138662FD09FC9A079DABB4007C1259A1F327F573A24B4B89675C95`
SHA512 | `F13B29C13909C62E75D65B5AC7C4CB75A87E7975036C92869B89CF87305C03D11610528AA32FD32228EBF07F0C37DABA10469D78ED16A46AEF50B7B189FCA787`
SSDEEP | `6144:u4e80dxZxUhG6fUaVaxMuFDm2RmOkfLoR7b9Rw:u9807ufUUMZFDDRD4QJRw`
IMP | `C91A16355F477B54CB12E12A395C9439`
PESHA1 | `A30AE24C1BAB66AA94B8DAA93771A5AE7883EB5E`
PE256 | `112FA81DDFE4881C18FA3695272FB81323C92F8FA84FD050598962A4EB712A61`
...
`unsigned int __cdecl at_rstr_chr(char const *,unsigned int,char)` | 44 | Exported Function
`unsigned int __cdecl at_rstr_chr(wchar_t const *,unsigned int,wchar_t)` | 45 | Exported Function
`unsigned int __cdecl at_rstr_convert(wchar_t *,unsigned int,unsigned char const *,unsigned int)` | 49 | Exported Function
`unsigned int __cdecl at_rstr_stri(wchar_t const *,unsigned int,wchar_t const *,unsigned int)` | 53 | Exported Function
`unsigned int __cdecl at_str_convert(int,char *,unsigned int,int,char const *,unsigned int)` | 54 | Exported Function
...
`at_fs_search` | 72 | Exported Function
`at_fs_tmpfile` | 73 | Exported Function
`at_vtrace_a` | 77 | Exported Function
`at_wstr_match` | 81 | Exported Function
`at_wstr_ncat` | 82 | Exported Function
`at_wstr_lwr` | 80 | Exported Function
`at_vtrace_w` | 78 | Exported Function
`at_wstr_chri` | 79 | Exported Function
`at_astr_ncat` | 64 | Exported Function
`at_astr_ncpy` | 65 | Exported Function
`at_astr_match` | 63 | Exported Function
`at_astr_chri` | 61 | Exported Function
`at_astr_lwr` | 62 | Exported Function
`at_astr_rchri` | 66 | Exported Function
`at_fs_find_first` | 70 | Exported Function
`at_fs_rmdirs` | 71 | Exported Function
`at_astr_upr` | 69 | Exported Function
`at_astr_rstri` | 67 | Exported Function
`at_astr_stri` | 68 | Exported Function
...
`at_wstr_stri` | 86 | Exported Function
`at_wstr_upr` | 87 | Exported Function
`at_wstr_rstri` | 85 | Exported Function
...
* Product Name: WebEx ptSSO
* Company Name: Cisco WebEx LLC
* File Version: 02804, 0000, 1307, 729
* Product Version: 02804, 0000, 1307, 729
...
* VirusTotal Link: https://www.virustotal.com/gui/file/d1456cf4e3239b48b4781f98c8d39173dd49e6ce80cff9380a85d5ff2b4ec9b9/detection/
