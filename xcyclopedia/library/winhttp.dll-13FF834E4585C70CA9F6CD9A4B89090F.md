...
*The following table contains possible examples of `winhttp.dll` being misused. While `winhttp.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
