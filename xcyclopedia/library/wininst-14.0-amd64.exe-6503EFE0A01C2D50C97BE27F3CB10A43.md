...
* File Path: `C:\program files\LibreOffice\program\python-core-3.7.7\lib\distutils\command\wininst-14.0-amd64.exe`
...
Path |
-- |
C:\program files\LibreOffice\program\python-core-3.7.7\lib\distutils\command\wininst-14.0-amd64.exe |
...
[C:\program files\Python38\Lib\distutils\command\wininst-14.0-amd64.exe](wininst-14.0-amd64.exe-6503EFE0A01C2D50C97BE27F3CB10A43.md) | 100
