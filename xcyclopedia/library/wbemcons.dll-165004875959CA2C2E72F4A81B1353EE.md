...
*The following table contains possible examples of `wbemcons.dll` being misused. While `wbemcons.dll` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
