...
* File Path: `C:\Program Files (x86)\Python310-32\Scripts\pip.exe`
...
Path |
-- |
C:\Program Files (x86)\Python310-32\Scripts\pip.exe |
C:\Windows\SYSTEM32\ntdll.dll |
...
* Status: The file C:\Program Files (x86)\Python310-32\Scripts\pip.exe is not digitally signed. You cannot run this script on the current system. For more information about running scripts and setting execution policy, see about_Execution_Policies at https:/go.microsoft.com/fwlink/?LinkID=135170
* Serial: ``
* Thumbprint: ``
* Issuer: 
* Subject: 
...
[C:\Program Files (x86)\Python310-32\Scripts\pip3.exe](pip3.exe-6AD2D25A7EB0868FD823C0D5BCAA751A.md) | 100
