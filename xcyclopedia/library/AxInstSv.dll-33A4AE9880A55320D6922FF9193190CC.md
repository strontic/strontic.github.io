---
title: AxInstSv.dll | ActiveX Installer Service
excerpt: What is AxInstSv.dll?
---
...
*The following table contains possible examples of `AxInstSv.dll` being misused. While `AxInstSv.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*

Source | Source File | Example | License
-- | -- | -- | --
[malware-ioc](https://github.com/eset/malware-ioc) | [nukesped_lazarus](https://github.com/eset/malware-ioc/blob/master/nukesped_lazarus/README.adoc) | `.`AxInstSV.dll`` | [© ESET 2014-2018](https://github.com/eset/malware-ioc/blob/master/LICENSE)
