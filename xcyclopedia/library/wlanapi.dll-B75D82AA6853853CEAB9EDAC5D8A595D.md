...
*The following table contains possible examples of `wlanapi.dll` being misused. While `wlanapi.dll` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
