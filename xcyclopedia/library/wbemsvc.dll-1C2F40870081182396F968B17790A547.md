...
*The following table contains possible examples of `wbemsvc.dll` being misused. While `wbemsvc.dll` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
