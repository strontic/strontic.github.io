...
*The following table contains possible examples of `CoreShell.dll` being misused. While `CoreShell.dll` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
