...
*The following table contains possible examples of `rawshark.exe` being misused. While `rawshark.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
