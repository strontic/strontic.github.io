...
*The following table contains possible examples of `gpsvc.dll` being misused. While `gpsvc.dll` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
