...
`PipelineClock::FakeSleep` | 29 | Exported Function
`PipeETWEvents::Initialize` | 41 | Exported Function
`PipeETWEvents::Enable` | 27 | Exported Function
`CRDPENCConnectorStringSerializer::XMLSerialize` | 71 | Exported Function
`Evict::InsertEntry` | 43 | Exported Function
`Evict::UnevictEntry` | 68 | Exported Function
`Evict::PromoteEntry` | 53 | Exported Function
`Evict::ParkEntry` | 48 | Exported Function
...
`CRDPENCConnectorStringSerializer::SetSessionId` | 62 | Exported Function
`CRdpGfxCapsSet::CreateInstance` | 19 | Exported Function
`CRDPENCONPort::CreateInstance` | 18 | Exported Function
`CRdpGfxCaps::IsSupportedVersion` | 44 | Exported Function
...
`PipelineClock::GetInstance` | 31 | Exported Function
`CRDPENCONIPHelper::Initialize` | 40 | Exported Function
`CRDPENCConnectorStringDeserializer::XMLDeserialize` | 70 | Exported Function
`CRDPENCConnectorStringDeserializer::GetPortMapping` | 36 | Exported Function
`CRDPENCONIPHelper::Terminate` | 67 | Exported Function
`NSCodecCompressor::CreateInstance` | 22 | Exported Function
`CRDPENCONResolver::SortAddresses` | 63 | Exported Function
`CRDPENCONResolver::AddConnection` | 12 | Exported Function
`CRDPCache::SearchCache` | 58 | Exported Function
`CRDPCache::Reset` | 57 | Exported Function
`CRDPCache::ClearCache` | 15 | Exported Function
`CRDPCache::SetCacheEntry` | 59 | Exported Function
`CRDPENCConnectorStringSerializer::SetConnectorId` | 60 | Exported Function
`CRDPENCConnectorStringSerializer::InitializeInstance` | 42 | Exported Function
...
`CRDPENCONIPHelper::GetNext` | 34 | Exported Function
`Evict::GetFreeEntry` | 30 | Exported Function
`Evict::EvictEntry` | 28 | Exported Function
`PipelineClock::GetMillisecondCount64` | 32 | Exported Function
`PipelineClock::GetTickCount` | 37 | Exported Function
`PipelineClock::GetMillisecondCount` | 33 | Exported Function
`CRDPENCONResolver::StartEnum` | 65 | Exported Function
...
`SSECBCHash2::ProcessAlignedData_SSE41` | 51 | Exported Function
`SSECBCHash2::ProcessAlignedData_SSE2` | 50 | Exported Function
`SSECBCHash2::ProcessAlignedData_AVX` | 49 | Exported Function
`SSECBCHash2::ProcessUnalignedData_REG` | 52 | Exported Function
...
`SSECBCHash2::UpdateKeys` | 69 | Exported Function
...
`PipelineClock::GetTimeHNS` | 38 | Exported Function
`SSECBCHash2::SSECBCHash2` | 7 | Exported Function
`NSCodecDecompressor::Decompress` | 25 | Exported Function
`CRDPENCONResolver::GetNext` | 35 | Exported Function
`CRDPENCONIPHelper::StartEnum` | 64 | Exported Function
`PipelineClock::IsTestMode` | 45 | Exported Function
...
`RdpGfxProtocolBaseDecoder::SetDecodeBuffer` | 61 | Exported Function
