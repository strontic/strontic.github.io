...
*The following table contains possible examples of `Everything.exe` being misused. While `Everything.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
