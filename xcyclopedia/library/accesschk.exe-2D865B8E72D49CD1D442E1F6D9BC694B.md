...
*The following table contains possible examples of `accesschk.exe` being misused. While `accesschk.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
