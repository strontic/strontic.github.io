---
title: apphelp.dll | Application Compatibility Client Library
excerpt: What is apphelp.dll?
---
...
File | Score
-- | --
[C:\Windows\system32\apphelp.dll](apphelp.dll-C6A2EA8C36C855AE178E83CCF223927A.md) | 33

## Possible Misuse

*The following table contains possible examples of `apphelp.dll` being misused. While `apphelp.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*

Source | Source File | Example | License
-- | -- | -- | --
[signature-base](https://github.com/Neo23x0/signature-base) | [apt_netwire_rat.yar](https://github.com/Neo23x0/signature-base/blob/master/yara/apt_netwire_rat.yar) | $s6 = "APPHELP" fullword ascii | [CC BY-NC 4.0](https://github.com/Neo23x0/signature-base/blob/master/LICENSE)
