---
title: ieframe.dll | Internet Browser
excerpt: What is ieframe.dll?
---
...
*The following table contains possible examples of `ieframe.dll` being misused. While `ieframe.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
...
[LOLBAS](https://github.com/LOLBAS-Project/LOLBAS) | [Ieframe.yml](https://github.com/LOLBAS-Project/LOLBAS/blob/master/yml/OSLibraries/Ieframe.yml) | `- Path: c:\windows\system32\ieframe.dll` | 
[LOLBAS](https://github.com/LOLBAS-Project/LOLBAS) | [Ieframe.yml](https://github.com/LOLBAS-Project/LOLBAS/blob/master/yml/OSLibraries/Ieframe.yml) | `- Path: c:\windows\syswow64\ieframe.dll` | 
[malware-ioc](https://github.com/eset/malware-ioc) | [rtm](https://github.com/eset/malware-ioc/blob/master/rtm/README.adoc) | `IEFrame` | [© ESET 2014-2018](https://github.com/eset/malware-ioc/blob/master/LICENSE)
