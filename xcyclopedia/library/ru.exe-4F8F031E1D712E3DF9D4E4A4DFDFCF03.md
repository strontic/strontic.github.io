...
*The following table contains possible examples of `ru.exe` being misused. While `ru.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
