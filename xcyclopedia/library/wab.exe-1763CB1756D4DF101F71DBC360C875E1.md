...
*The following table contains possible examples of `wab.exe` being misused. While `wab.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
