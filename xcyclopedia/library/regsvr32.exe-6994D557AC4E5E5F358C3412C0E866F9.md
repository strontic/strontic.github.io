...
Type | Hash
-- | --
MD5 | `6994D557AC4E5E5F358C3412C0E866F9`
SHA1 | `8EEE4E2235F38644A213A1FCF0D3DECF2B95D1E0`
SHA256 | `D248A3EBDA8FAA54907EF86A9CF4EF3AB9A99A284EC36BE410A20FDA5F856C77`
...
* Status: The file C:\windows\system32\regsvr32.exe is not digitally signed. You cannot run this script on the current system. For more information about running scripts and setting execution policy, see about_Execution_Policies at http://go.microsoft.com/fwlink/?LinkID=135170
* Serial: ``
* Thumbprint: ``
* Issuer: 
* Subject: 
...
File | Score
-- | --
[C:\windows\SysWOW64\regsvr32.exe](regsvr32.exe-E457CB1C6A436873D5E1B5E3EDA71248.md) | 33
