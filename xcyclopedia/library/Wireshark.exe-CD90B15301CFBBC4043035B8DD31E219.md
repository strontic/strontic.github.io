...
*The following table contains possible examples of `Wireshark.exe` being misused. While `Wireshark.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
