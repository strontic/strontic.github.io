...
*The following table contains possible examples of `smoke.exe` being misused. While `smoke.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
