...
*The following table contains possible examples of `adrestore.exe` being misused. While `adrestore.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
