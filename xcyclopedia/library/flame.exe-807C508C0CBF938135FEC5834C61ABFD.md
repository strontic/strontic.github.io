---
title: flame.exe | GNU Image Manipulation Program Plug-In
excerpt: What is flame.exe?
---
...
Type | Hash
-- | --
MD5 | `807C508C0CBF938135FEC5834C61ABFD`
SHA1 | `23547F298043DC9C32283C5D72CCF83948555169`
SHA256 | `51F9F5E0D03DC543A0F1F5B273E98A8002B48EEE68F5377A01140A53055D3D04`
...
*The following table contains possible examples of `flame.exe` being misused. While `flame.exe` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*

Source | Source File | Example | License
-- | -- | -- | --
[malware-ioc](https://github.com/eset/malware-ioc) | [nouns.txt](https://github.com/eset/malware-ioc/blob/master/kryptocibule/nouns.txt) | `flame`{:.highlight .language-cmhg} | [© ESET 2014-2018](https://github.com/eset/malware-ioc/blob/master/LICENSE)
