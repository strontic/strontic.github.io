...
*The following table contains possible examples of `Tcpview.exe` being misused. While `Tcpview.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
