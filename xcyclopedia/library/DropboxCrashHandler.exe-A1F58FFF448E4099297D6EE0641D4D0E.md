---
title: DropboxCrashHandler.exe | Dropbox Update
excerpt: What is DropboxCrashHandler.exe?
---

# DropboxCrashHandler.exe 

* File Path: `C:\Program Files (x86)\Dropbox\Update\1.3.335.1\DropboxCrashHandler.exe`
* Description: Dropbox Update

## Screenshot

![DropboxCrashHandler.exe](screenshots/DropboxCrashHandler.exe-A1F58FFF448E4099297D6EE0641D4D0E-1.png)
...
(RW-)   C:\ProgramData\Dropbox\Update\Log\DropboxUpdate.log-2020-09-24-22-44-00-842-5744 | File
(RW-)   C:\Windows | File
...
Path |
-- |
C:\Program Files (x86)\Dropbox\Update\1.3.335.1\DropboxCrashHandler.exe |
C:\Windows\SYSTEM32\ntdll.dll |
...
[C:\Program Files (x86)\Dropbox\Update\DropboxUpdate.exe](DropboxUpdate.exe-A1F58FFF448E4099297D6EE0641D4D0E.md) | 100
