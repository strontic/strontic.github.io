...
*The following table contains possible examples of `mscoree.dll` being misused. While `mscoree.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
