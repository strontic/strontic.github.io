...
*The following table contains possible examples of `termsrv.dll` being misused. While `termsrv.dll` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
