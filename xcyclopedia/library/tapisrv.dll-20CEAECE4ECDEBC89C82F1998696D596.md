---
title: tapisrv.dll | Microsoft Windows(TM) Telephony Server
excerpt: What is tapisrv.dll?
---
...
-- | -- | -- | -- | --
`ServiceMain` | 1 (0x1) | Exported Function | 0x00000001800254e0 | 0x000254e0
`SvchostPushServiceGlobals` | 2 (0x2) | Exported Function | 0x0000000180025290 | 0x00025290
...
*The following table contains possible examples of `tapisrv.dll` being misused. While `tapisrv.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*

Source | Source File | Example | License
-- | -- | -- | --
[malware-ioc](https://github.com/eset/malware-ioc) | [nukesped_lazarus](https://github.com/eset/malware-ioc/blob/master/nukesped_lazarus/README.adoc) | `.`tapisrv.dll`` | [© ESET 2014-2018](https://github.com/eset/malware-ioc/blob/master/LICENSE)
