...
*The following table contains possible examples of `FLTLDR.EXE` being misused. While `FLTLDR.EXE` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
