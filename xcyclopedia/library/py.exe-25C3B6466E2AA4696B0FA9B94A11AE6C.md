...
*The following table contains possible examples of `py.exe` being misused. While `py.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
