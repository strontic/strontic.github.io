...
SHA1 | `98450DEF7868B92E812DB8F8C4404B2435963E5F`
SHA256 | `CA41280CB0067932B20A7248CA18BA5E3745939FC91906DB11C1571764E2DFD0`
...
```cmhg
 ...
 RtParser v1.2 
  ...
  - usage : RtParser sourcefilepath(.rt format) destfilepath(.smi format) 

   Copyright(C) 2003-2005 GRETECH Corp.
   All Rights Reserved. (maybe)
   Coding by koder 
   First  Release(1.0) in 2003/10/02 
   Second Release(1.1) in 2004/04/30 : slash(/) in text problem fixed 
   Third  Release(1.2) in 2005/07/14 : time parsing problem fixed 
...
* Serial: `1472BF5317E0965C879EF989EB6864AD`
* Thumbprint: `0B982DFDC1CB66EB18E0A2B93A43C60C99D947D2`
...
* Subject: CN=GRETECH, OU=Digital ID Class 3 - Microsoft Software Validation v2, O=GRETECH, L=Gangnam-gu, S=Seoul, C=KR
