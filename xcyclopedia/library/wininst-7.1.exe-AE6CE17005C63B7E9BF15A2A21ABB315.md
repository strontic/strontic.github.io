...
* File Path: `C:\program files\LibreOffice\program\python-core-3.7.7\lib\distutils\command\wininst-7.1.exe`
...
Path |
-- |
C:\program files\LibreOffice\program\python-core-3.7.7\lib\distutils\command\wininst-7.1.exe |
C:\Windows\SYSTEM32\ntdll.dll |
