...
*The following table contains possible examples of `chrome_elf.dll` being misused. While `chrome_elf.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
