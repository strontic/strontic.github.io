---
title: imm32.dll | Multi-User Windows IMM32 API Client DLL
excerpt: What is imm32.dll?
---
...
File | Score
-- | --
[C:\Windows\system32\imm32.dll](imm32.dll-08B62B14F4A67BECAF911136D55CF126.md) | 36

## Possible Misuse

*The following table contains possible examples of `imm32.dll` being misused. While `imm32.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*

Source | Source File | Example | License
-- | -- | -- | --
[sigma](https://github.com/Neo23x0/sigma) | [sysmon_mimikatz_inmemory_detection.yml](https://github.com/Neo23x0/sigma/blob/master/rules/windows/image_load/sysmon_mimikatz_inmemory_detection.yml) | `- 'imm32.dll'` | [DRL 1.0](https://github.com/Neo23x0/sigma/blob/master/LICENSE.Detection.Rules.md)
