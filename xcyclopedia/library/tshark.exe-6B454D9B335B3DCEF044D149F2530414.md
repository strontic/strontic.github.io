...
*The following table contains possible examples of `tshark.exe` being misused. While `tshark.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
