...
-- | -- | -- | --
[sigma](https://github.com/Neo23x0/sigma) | [macos_network_sniffing.yml](https://github.com/Neo23x0/sigma/blob/master/rules/linux/macos_network_sniffing.yml) | `- '/tshark'`{:.highlight .language-yaml} | [DRL 1.0](https://github.com/Neo23x0/sigma/blob/master/LICENSE.Detection.Rules.md)
