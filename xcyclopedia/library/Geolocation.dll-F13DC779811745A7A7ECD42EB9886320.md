---
title: Geolocation.dll | Geolocation Runtime DLL
excerpt: What is Geolocation.dll?
---
...
-- | -- | -- | -- | --
`DllCanUnloadNow` | 1 (0x1) | Exported Function | 0x0000000180011230 | 0x00011230
`DllGetActivationFactory` | 2 (0x2) | Exported Function | 0x0000000180011270 | 0x00011270
`DllGetClassObject` | 3 (0x3) | Exported Function | 0x00000001800112b0 | 0x000112b0
...
*The following table contains possible examples of `Geolocation.dll` being misused. While `Geolocation.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*

Source | Source File | Example | License
-- | -- | -- | --
[malware-ioc](https://github.com/eset/malware-ioc) | [groundbait](https://github.com/eset/malware-ioc/blob/master/groundbait/README.adoc) | `=== Prikormka *GEOLOCATION* modules` | [© ESET 2014-2018](https://github.com/eset/malware-ioc/blob/master/LICENSE)
