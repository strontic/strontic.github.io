...
-- | -- | --
`CBdeCfgLibraryLoader::CBdeCfgLibraryLoader` | 7 | Exported Function
`public: __cdecl CBdeCfgLibraryLoader::~CBdeCfgLibraryLoader(void) __ptr64` | 12 | Exported Function
`CDriveConfiguration::CDriveConfiguration` | 8 | Exported Function
`CBdeCfgLibraryLoader::CBdeCfgLibraryLoader` | 6 | Exported Function
`CBcdStore::CBcdStore` | 2 | Exported Function
`CBcdStore::CBcdStore` | 3 | Exported Function
`CBcdWmiWrapper::CBcdWmiWrapper` | 5 | Exported Function
`CDriveConfiguration::ActionRequiresMerge` | 22 | Exported Function
`CDriveConfiguration::ActionRequiresShrink` | 23 | Exported Function
`CDriveConfiguration::Initialized` | 94 | Exported Function
`CDriveConfiguration::ActionRequiresCreate` | 21 | Exported Function
`CDriveConfiguration::CDriveConfiguration` | 9 | Exported Function
`public: __cdecl CDriveConfiguration::~CDriveConfiguration(void) __ptr64` | 13 | Exported Function
`CBdeCfgLibraryLoader::LibraryLoaded` | 96 | Exported Function
`CDriveConfiguration::InitializeEntry` | 90 | Exported Function
`CDriveConfiguration::Cleanup` | 64 | Exported Function
`CBcdStore::CBcdStore` | 1 | Exported Function
`CDriveConfiguration::DriveConfigurationEntry` | 69 | Exported Function
`CDriveConfiguration::Thread_Initialize` | 103 | Exported Function
`CBdeCfgLibraryLoader::InitializeAndHoldLibraryEntry` | 87 | Exported Function
`CDriveConfiguration::CancelConfigurationEntry` | 62 | Exported Function
`CBcdWmiWrapper::InitializeInstance` | 92 | Exported Function
`CBcdWmiWrapper::GetNamespace` | 75 | Exported Function
`protected: virtual __cdecl CBcdWmiWrapper::~CBcdWmiWrapper(void) __ptr64` | 11 | Exported Function
`CBcdWmiWrapper::InitializeClass` | 89 | Exported Function
`CBcdWmiWrapper::CBcdWmiWrapper` | 4 | Exported Function
`CBcdWmiWrapper::CreateInParams` | 67 | Exported Function
`CBcdWmiWrapper::ExecuteMethod` | 70 | Exported Function
`CBcdStore::operator` | 14 | Exported Function
`CDriveConfiguration::GetShrinkSize` | 78 | Exported Function
`CDriveConfiguration::GetTargetPartitionSize` | 83 | Exported Function
`CDriveConfiguration::GetNumberOfSteps` | 77 | Exported Function
`CBcdStore::CreateClass` | 66 | Exported Function
`CDriveConfiguration::Initialize` | 85 | Exported Function
`CDriveConfiguration::IsMergeTargetWinRE` | 95 | Exported Function
`CDriveConfiguration::QueryStepPercentComplete` | 99 | Exported Function
`CDriveConfiguration::GetTargetDriveLetter` | 81 | Exported Function
`public: virtual __cdecl CBcdStore::~CBcdStore(void) __ptr64` | 10 | Exported Function
`CBdeCfgLibraryLoader::Unload` | 104 | Exported Function
`CDriveConfiguration::GetNewDriveLetter` | 76 | Exported Function
`CDriveConfiguration::GetStepExecutionOrder` | 79 | Exported Function
`CDriveConfiguration::GetTargetDiskNumber` | 80 | Exported Function
`CDriveConfiguration::GetTargetPartitionNumber` | 82 | Exported Function
`CDriveConfiguration::GetActionType` | 72 | Exported Function
`CBcdStore::ExportSystemStore` | 71 | Exported Function
`CBcdStore::ImportSystemStore` | 84 | Exported Function
`CDriveConfiguration::operator` | 18 | Exported Function
`CBcdStore::operator` | 15 | Exported Function
`CBcdWmiWrapper::operator` | 16 | Exported Function
`CBdeCfgLibraryLoader::operator` | 17 | Exported Function
`CDriveConfiguration::ConfigureDrive` | 65 | Exported Function
`CDriveConfiguration::GetConfigurationResult` | 73 | Exported Function
`CDriveConfiguration::GetInitializationResult` | 74 | Exported Function
`CDriveConfiguration::CancelConfiguration` | 61 | Exported Function
`CBcdStore::OpenStore` | 98 | Exported Function
`CBcdStore::RemapObjectDevices` | 100 | Exported Function
`CBdeCfgLibraryLoader::Load` | 97 | Exported Function
...
`CBcdWmiWrapper::InitializeNamespace` | 93 | Exported Function
...
`CDriveConfiguration::InitializeFromParams` | 91 | Exported Function
`CDriveConfiguration::SetConfigurationStep` | 101 | Exported Function
`CDriveConfiguration::Thread_ConfigureDrive` | 102 | Exported Function
`CDriveConfiguration::DetectTargetDrive` | 68 | Exported Function
`CBdeCfgLibraryLoader::InitializeAndHoldLibrary` | 86 | Exported Function
`CBdeCfgLibraryLoader::InitializeAndHoldLibrary_Thread` | 88 | Exported Function
`CDriveConfiguration::CancelConfiguration_Thread` | 63 | Exported Function
