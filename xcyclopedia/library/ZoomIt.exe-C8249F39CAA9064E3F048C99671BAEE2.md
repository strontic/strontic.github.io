...
*The following table contains possible examples of `ZoomIt.exe` being misused. While `ZoomIt.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
