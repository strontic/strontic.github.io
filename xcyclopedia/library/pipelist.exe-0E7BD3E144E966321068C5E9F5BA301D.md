...
*The following table contains possible examples of `pipelist.exe` being misused. While `pipelist.exe` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
