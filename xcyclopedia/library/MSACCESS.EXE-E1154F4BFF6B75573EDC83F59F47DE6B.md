...
*The following table contains possible examples of `MSACCESS.EXE` being misused. While `MSACCESS.EXE` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
