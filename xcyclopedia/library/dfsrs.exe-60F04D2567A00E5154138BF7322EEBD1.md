...
*The following table contains possible examples of `dfsrs.exe` being misused. While `dfsrs.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
