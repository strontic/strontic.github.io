---
title: IEAdvpack.dll | ADVPACK
excerpt: What is IEAdvpack.dll?
---
...
File | Score
-- | --
[C:\Windows\SysWOW64\advpack.dll](advpack.dll-1C6D088367A777EB13A8E459C5E5CF3A.md) | 85

## Possible Misuse

*The following table contains possible examples of `IEAdvpack.dll` being misused. While `IEAdvpack.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*

Source | Source File | Example | License
-- | -- | -- | --
[LOLBAS](https://github.com/LOLBAS-Project/LOLBAS) | [Ieadvpack.yml](https://github.com/LOLBAS-Project/LOLBAS/blob/master/yml/OSLibraries/Ieadvpack.yml) | `Name: Ieadvpack.dll` | 
...
[LOLBAS](https://github.com/LOLBAS-Project/LOLBAS) | [Ieadvpack.yml](https://github.com/LOLBAS-Project/LOLBAS/blob/master/yml/OSLibraries/Ieadvpack.yml) | `- Path: c:\windows\system32\ieadvpack.dll` | 
[LOLBAS](https://github.com/LOLBAS-Project/LOLBAS) | [Ieadvpack.yml](https://github.com/LOLBAS-Project/LOLBAS/blob/master/yml/OSLibraries/Ieadvpack.yml) | `- Path: c:\windows\syswow64\ieadvpack.dll` | 
[LOLBAS](https://github.com/LOLBAS-Project/LOLBAS) | [Ieadvpack.yml](https://github.com/LOLBAS-Project/LOLBAS/blob/master/yml/OSLibraries/Ieadvpack.yml) | `- Code: https://github.com/LOLBAS-Project/LOLBAS-Project.github.io/blob/master/_lolbas/Libraries/Payload/Ieadvpack.inf` | 
