---
title: OfficeClickToRun.exe | Microsoft Office Click-to-Run (SxS)
...
*The following table contains possible examples of `OfficeClickToRun.exe` being misused. While `OfficeClickToRun.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
