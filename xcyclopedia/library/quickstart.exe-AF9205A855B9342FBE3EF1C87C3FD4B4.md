...
*The following table contains possible examples of `quickstart.exe` being misused. While `quickstart.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
