---
title: winmm.dll | MCI API DLL
excerpt: What is winmm.dll?
---
...
*The following table contains possible examples of `winmm.dll` being misused. While `winmm.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
