...
File | Score
-- | --
[C:\program files\Mozilla Thunderbird\thunderbird.exe](thunderbird.exe-3C010B5C2E94A65E8BBCF62C880D9DC4.md) | 55
[C:\Program Files\Mozilla Thunderbird\thunderbird.exe](thunderbird.exe-77EB6156F1177F3F897269026B203841.md) | 69

## Possible Misuse

*The following table contains possible examples of `thunderbird.exe` being misused. While `thunderbird.exe` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
