...
*The following table contains possible examples of `SENDTO.DLL` being misused. While `SENDTO.DLL` is **not** inherently malicious, its legitimate functionality can be abused for malicious purposes.*
