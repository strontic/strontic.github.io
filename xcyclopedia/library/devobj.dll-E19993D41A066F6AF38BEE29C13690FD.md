...
*The following table contains possible examples of `devobj.dll` being misused. While `devobj.dll` is **not** inherently malicious, its legitimate functionality can by abused for malicious purposes.*
