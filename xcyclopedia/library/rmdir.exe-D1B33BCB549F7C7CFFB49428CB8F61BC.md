...
-- | -- | -- | --
[sigma](https://github.com/Neo23x0/sigma) | [lnx_clear_logs.yml](https://github.com/Neo23x0/sigma/blob/master/rules/linux/process_creation/lnx_clear_logs.yml) | `- '/rm'    # covers /rmdir as well`{:.highlight .language-yaml} | [DRL 1.0](https://github.com/Neo23x0/sigma/blob/master/LICENSE.Detection.Rules.md)
[sigma](https://github.com/Neo23x0/sigma) | [lnx_file_deletion.yml](https://github.com/Neo23x0/sigma/blob/master/rules/linux/process_creation/lnx_file_deletion.yml) | `- '/rm'     # covers /rmdir as well`{:.highlight .language-yaml} | [DRL 1.0](https://github.com/Neo23x0/sigma/blob/master/LICENSE.Detection.Rules.md)
[sigma](https://github.com/Neo23x0/sigma) | [win_apt_revil_kaseya.yml](https://github.com/Neo23x0/sigma/blob/master/rules/windows/process_creation/win_apt_revil_kaseya.yml) | `- 'rmdir /s /q %SystemDrive%\inetpub\logs'`{:.highlight .language-yaml} | [DRL 1.0](https://github.com/Neo23x0/sigma/blob/master/LICENSE.Detection.Rules.md)
...
[atomic-red-team](https://github.com/redcanaryco/atomic-red-team) | [T1036.005.md](https://github.com/redcanaryco/atomic-red-team/blob/master/atomics/T1036.005/T1036.005.md) | rmdir $HOME/.../ | [MIT License. © 2018 Red Canary](https://github.com/redcanaryco/atomic-red-team/blob/master/LICENSE.txt)
